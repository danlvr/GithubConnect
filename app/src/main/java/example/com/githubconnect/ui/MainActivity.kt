...
import example.com.githubconnect.core.createDialog
import example.com.githubconnect.core.createProgressDialog
import example.com.githubconnect.core.hideSoftKeyboard
...
class MainActivity : AppCompatActivity(), SearchView.OnQueryTextListener {
    ...
    override fun onQueryTextSubmit(query: String?): Boolean {
        query?.let { viewModel.getRepositoriesList(it) }
